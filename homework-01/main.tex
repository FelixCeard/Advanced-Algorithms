...
\subsection{\textbf{Prove that Till's Stable Matching algorithm leads to a perfect matching and terminates, or give a counter example.}}
...
\subsection{\textbf{Prove that Till's algorithm leads to a stable perfect matching, or give a counter example.}}
